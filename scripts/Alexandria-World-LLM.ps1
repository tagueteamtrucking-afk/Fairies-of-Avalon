...
Include: premise, themes, geography (regions & landmarks), cultures & societies, magic rules ({$MagicStyle}), technology, factions, economy, pantheon, bestiary seeds, quest hooks, session zero boundaries & safety tools.
Include 'dice prompts' the DM can ask players to roll for random details.
Output STRICT JSON:
