...
function ParseCsv($path){
  try{ return Import-Csv -Path $path -ErrorAction Stop } catch { return @() }
}

# Known files (names from Samsung Health exports; tolerate variants)
$map = @{
...
$outDir = Join-Path $root 'pages/apps/jem/biometrics'
