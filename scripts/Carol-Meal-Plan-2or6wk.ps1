...
Deliver:
- A $Weeks-week plan for TWO with **6–8 snack-size eating events per day** per person (label type: "snack" or "mini-meal"), with per-event kcal/sodium/added_sugars/fiber and specific quantities.
- Mark each event with { for: "A"|"B"|"Both", type: "snack"|"mini-meal", time_hint: "morning|midday|evening|night-shift" } to support **opposite schedules**.
...
$user = "Names: A=Ray, B=Blanca. Keep prep short. Lean on slow-cooker and convection oven. Provide swaps to avoid cilantro/cumin and to ease onions/peppers."
